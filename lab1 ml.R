...
student_data$pass <- as.factor(ifelse(student_data$final_result == "Pass", 1, 0))
...
logit_model <- glm(pass ~ disability_status + imd_numeric, family = binomial(link = "logit"), data = train_set)
